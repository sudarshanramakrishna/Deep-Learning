...
# Display image
    image = Image.open('/Users/shreyanthhg/Desktop/Artificial_neural_network/Heart_attack_predication_web_app_streamlit_final/heart.jpeg')
...
def main():
    ...
    # Load data
    data = load_data("/Users/shreyanthhg/Desktop/Artificial_neural_network/Heart_attack_predication_web_app_streamlit_final/heart_failure_clinical_records_dataset.csv")
